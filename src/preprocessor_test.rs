mod tests {
    ...
    fn test_preprocessor_creation() {
        ...
        assert_eq!(pp.macros.len(), 6); // Predefined macros: __CC2__, __STDC__, __STDC_VERSION__, __STDC_HOSTED__, __DATE__, __TIME__
    ...
    fn test_preprocessor_creation_no_std() {
        ...
        assert_eq!(pp.macros.len(), 6); // Predefined macros are added even with nostdinc
